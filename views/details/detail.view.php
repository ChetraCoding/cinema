...
<div class="mx-11 my-10 bg-gray-800 ">
  ...
  <?php foreach ($times as $time): 
    $showId = $_GET['show_id'];
    $dateId = $time['release_date_id'];?>

    <a href="<?= date("Y-m-d") > $time['date']? "#" : "/detail/seat?show_id=$showId&date_id=$dateId" ?>">
      <div class="<?= date("Y-m-d") > $time['date']? "bg-gray-500" : "bg-gray-100" ?> rounded-lg border-gray-400 p-4 flex flex-col justify-between">
